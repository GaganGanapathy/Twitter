      ...
      <div className=" ms-auto flex justify-end">
        <div className="flex flex-col justify-between h-screen  pb-10 pe-5">
          <div className="flex flex-col gap-y-3">
            ...
            {/* Logout */}
            <button
              className="flex hover:bg-blue-300 hover:rounded-full ps-2 py-1"
          ...
          <div className="flex items-center gap-x-2 ps-2">
            <div className="bg-slate-300 rounded-full overflow-hidden w-10 h-10">
              {user.user.picture?.url ? (
                ...
                <Avatar name={user.user.name} color="#BA68C8" size="40px" />
              )}
            </div>
            <div>
              <p>{user.user.name}</p>
